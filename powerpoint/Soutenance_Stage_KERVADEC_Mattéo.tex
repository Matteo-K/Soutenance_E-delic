...
\newcommand{\kpiBox}[3]{
  \begin{tikzpicture}[baseline]
    \node[draw=#3!80!black, fill=#3!10, rounded corners=5pt,
          minimum width=3.6cm, minimum height=1.8cm, % largeur et hauteur fixes
  		...
  		\begin{minipage}{0.9\textwidth}
			\begin{columns}
  				\column{0.48\textwidth}
  					\kpiBox{Implantation}{Depuis 2004}{blue}
  					\vspace{0.5em}
    					...
    					\vspace{0.5em}
  				\column{0.48\textwidth}
    					\kpiBox{Google Partner}{Depuis 2020}{orange}
    					\vspace{0.5em}
    					\kpiBox{Émissions CO$_2$}{$1,75\,kg$/1000 vues}{teal}
    					\vspace{0.5em}
			\end{columns}
  		\end{minipage}
	\end{center}
